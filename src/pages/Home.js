...
export default function Home() {
    ...
    //   sousTexte: t('gallery'),
    //   piliers: [
    //     { icon: "🛠️", color: "#495057", titre: "SAV", texte: t('details') },
    //     { icon: "⚓", color: "#495057", titre: "Management", texte: t('details') },
    //     { icon: "⛵", color: "#495057", titre: "Charter", texte: t('details') },
    //     { icon: "🚤", color: "#495057", titre: "Vente d'occasion", texte: t('details') }
    //   ]
    // });
    ...
    <div className="bg-light min-vh-100">
      ...
      >
        <div style={{width:'100%', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap: isMobile ? 16 : 28}}>
          ...
          <div style={{
            ...
            background: isMobile ? 'rgba(255, 255, 255, 0)' : 'none',
            borderRadius: 16,
            boxShadow: '0 2px 12px #0001',
            padding: isMobile ? '18px 12px' : '18px 12px',
      ...
      <div id="bateaux" style={{ paddingTop: 80, background: "#f8f9fa", minHeight: "100vh" }}>
        <div className="container py-4">
          <h2 className="text-center mb-4" style={{ fontWeight: 800, fontSize: 36, color: "#232323", letterSpacing: 0.5, textShadow: '0 2px 8px #23232311' }}>{t('boats')}</h2>
              ...
              >
                ...
                >
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', padding: 32, paddingBottom: 18, background: '#fff' }}>
                    ...
                    <div style={{ color: '#888', fontSize: 15, textAlign: 'center', marginTop: 0, fontWeight: 500 }}>{t('details')}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="galerie" className="py-5" style={{ background: '#fff' }}>
        <div className="container">
          <h2 className="text-center mb-5" style={{ fontWeight: 700, fontSize: isMobile ? 22 : isTablet ? 28 : 32, color: '#2c3e50', letterSpacing: -0.5 }}>{t('gallery')}</h2>
